        ...
        <div class="am-panel am-panel-default am-text-sm">
            <div class="am-panel-bd">
                ...
                <div class="header">
                    ...
                    <p class="am-text-danger">—— 让大家更好地编写文档，让万物有迹可查，让问题得到专业的解决方案</p>
                    <hr/>
                </div>
                <?php include $file; ?>
...
<div class="pes-success" style="display: none">
    <div class="am-block am-text-center am-margin-top">
        <a href="<?= str_replace("Install", "", DOCUMENT_ROOT) ?>"  target="_blank" class="am-btn am-btn-success am-margin-left-sm am-inline am-btn-sm">马上查看</a>
    </div>
</div>
