...
INSERT INTO `pes_menu` VALUES (1,'首页',0,'am-icon-home','/',1,1),(2,'文档列表',0,'','',2,2),(5,'PESCMS官网',0,'','https://www.pescms.com',3,1);
...
INSERT INTO `pes_model` VALUES (1,'model','模型管理',1,1,2,10),(2,'field','字段管理',1,1,2,10),(3,'menu','前台菜单管理',1,1,2,10),(4,'route','路由规则',1,1,2,10),(5,'Doc','文档管理',0,0,1,10),(13,'Node','权限节点管理',1,1,2,10),(20,'Member','用户管理',1,1,1,10),(24,'attachment','附件管理',1,0,2,30),(26,'member_organize','用户分组',1,0,2,10),(27,'Article_template','文档通用模板',1,0,2,10);
...
INSERT INTO `pes_option` VALUES (-3,'help_document','已读帮助信息','0','隐藏信息','system','string','text','',0,'',99),(-2,'version','程序版本','','系统版本','system','string','text','',1,'',0),(-1,'setting_sort','设置排序','{\"\\u4e0a\\u4f20\\u8bbe\\u7f6e\":2,\"\\u7f51\\u7ad9\\u4fe1\\u606f\":1,\"\\u8d26\\u53f7\\u8bbe\\u7f6e\":3}\r\n','设置排序','sort','array','text','',0,'',0),(1,'upload_img','图片格式','[\".jpg\",\".jpge\",\".bmp\",\".gif\",\".png\"]','上传设置','upload','json','text','',1,'',0),(2,'upload_file','文件格式','[\".zip\",\".rar\",\".7z\",\".doc\",\".docx\",\".pdf\",\".xls\",\".xlsx\",\".ppt\",\".pptx\",\".txt\"]','上传设置','upload','json','text','',1,'',0),(3,'max_upload_size','上传大小(M)','30','上传设置','upload','string','text','',1,'',0),(4,'siteTitle','网站标题','PESCMS DOC文档管理系统','网站信息','system','string','text','',1,'',1),(5,'siteLogo','网站LOGO','','网站信息','system','string','thumb','',1,'',2),(6,'siteFooter','网站页脚','','网站信息','system','string','textarea','',0,'',5),(7,'siteScript','网站脚本','','网站信息','system','string','textarea','',0,'若您需要添加网站统计代码，请在此处填写',6),(8,'open_register','开启注册','0','账号设置','system','string','radio','{\"关闭\":\"0\",\"开启\":\"1\"}',1,'若您需要用户系统，请开启此选项。再根据自身业务，选择对应的账号设置',0),(9,'register_group','注册默认分组','3','账号设置','system','string','select','{\"\\u7cfb\\u7edf\\u7ba1\\u7406\\u7ec4\":1,\"\\u6587\\u6863\\u7ef4\\u62a4\\u7ec4\":2,\"\\u8bbf\\u5ba2\":3}',1,'',0),(10,'register_review','账号注册审核','0','账号设置','system','string','radio','{\"审核\":\"0\",\"不审核\":\"1\"}',1,'不审核的话，将账号可以直接登录系统。',0),(12,'verifyLength','验证码长度','4','网站信息','system','string','text','',0,'',8),(13,'authorize','软件授权码','','网站信息','','string','text','',0,'',99),(14,'keyword','网站关键词','','网站信息','system','string','text','',0,'',3),(15,'description','网站描述','','网站信息','system','string','textarea','',0,'SEO相关设置',4),(16,'siteStyle','网站样式','','网站信息','system','string','textarea','',0,'若您希望网站UI不一样，可以在这里填写您的CSS。',7);
...
-- Dump completed on 2022-05-31 22:12:07
