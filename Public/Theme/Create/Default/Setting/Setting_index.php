...
<script>
    ...
    $(function () {
        ...
        setTimeout(function () {
            $('input[name="api_secret"]').after('<button type="button" class="am-btn am-btn-primary am-btn-xs am-radius am-margin-top" onclick="generateSecret()"><i class="am-icon-refresh"></i> 生成新的API KEY和Secret</button>')
        }, 200)
