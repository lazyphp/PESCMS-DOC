            ...
            <?php foreach($list as $patchName => $item): ?>
                <li>
                    <div class="am-gallery-item am-text-center">
                        <a href="<?= DOCUMENT_ROOT ?>/Theme/Doc/<?= $patchName ?>/<?= $item['img'] ?>" data-fancybox="gallery">
                            <img src="<?= DOCUMENT_ROOT ?>/Theme/Doc/<?= $patchName ?>/<?= $item['img'] ?>" class="am-img-thumbnail"  alt=""/>
                        </a>
...
<div id="app-list" class=" am-hide" project="3" version="<?= $system['version'] ?>" entrance="ThemeCenter">正在连接PESCMS主题商店...</div>
