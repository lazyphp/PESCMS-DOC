    ...
    <div class="am-u-sm-12 am-u-sm-centered">
        <div class="am-form-group">
            ...
            <label class="am-radio-inline">
                <input type="radio" value="0" name="article_node" <?= isset($article_node) && $article_node == 0 && is_numeric($article_node) ? 'checked="checked"' : '' ?> required>
                文章
            </label>
            <label class="am-radio-inline">
                <input type="radio" value="1" name="article_node" <?= isset($article_node) && $article_node == 1 && is_numeric($article_node) ? 'checked="checked"' : '' ?> required>
                目录
            </label>
            <label class="am-radio-inline">
