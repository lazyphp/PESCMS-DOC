...
<textarea class="am-hide" name="md"><?= $article_content_md ?></textarea>
<textarea class="am-hide" name="html"><?= $article_content ?></textarea>
<input type="hidden" name="editor" value="<?= $article_content_editor ?>">

<div class="am-g am-g-collapse">
    <div class="am-u-sm-12 am-u-sm-centered">
        <div class="am-form-group">
            <label class="am-block">文档标题</label>
            <input type="text" name="article_title" value="<?= $article_title ?>"  placeholder="文档标题" required>
        </div>
    </div>
</div>
    ...
    <div class="am-u-sm-12 am-u-sm-centered">
        <div class="am-form-group">
            ...
            <label class="am-radio-inline">
                <input type="radio"  value="0" name="article_node" <?= $article_node == 0 && is_numeric($article_node) ? 'checked="checked"' : '' ?> required> 文章
            </label>
            <label class="am-radio-inline">
                <input type="radio" value="1" name="article_node" <?= $article_node == 1 && is_numeric($article_node) ? 'checked="checked"' : '' ?> required> 目录
            </label>
            <label class="am-radio-inline">
                <input type="radio" value="2" name="article_node" <?= $article_node == 2 && is_numeric($article_node) ? 'checked="checked"' : '' ?> required> 外链文章
            </label>
        </div>
    </div>
</div>
...
<div class="am-g am-g-collapse">
    <div class="am-u-sm-12 am-u-sm-centered">
        <div class="am-form-group">
            ...
            <input type="text" name="article_listsort" value="<?= $article_listsort ?>"  placeholder="文档权重升序，默认是创建顺序倒叙">
        </div>
    </div>
</div>
...
<div class="am-g am-g-collapse article_external_link">
    <div class="am-u-sm-12 am-u-sm-centered">
        <div class="am-form-group">
            ...
            <input type="text" name="article_external_link" value="<?= $article_external_link ?>"  placeholder="文档外链地址">
        </div>
    </div>
</div>
...
<div class="am-g am-g-collapse pes-article-editor">
    <div class="am-u-sm-12 am-u-sm-centered">
        <div class="am-form-group">
            ...
            <input type="text" name="article_keyword" value="<?= $article_keyword ?>"  placeholder="文档关键词">
        </div>
    </div>
</div>
...
<div class="am-g am-g-collapse pes-article-editor">
    <div class="am-u-sm-12 am-u-sm-centered">
        <div class="am-form-group">
            ...
            <textarea name="article_description" placeholder="文档描述" rows="5"><?= $article_description ?></textarea>
        </div>
    </div>
</div>
...
<div class="am-g am-g-collapse">
    <div class="am-u-sm-12 am-u-sm-centered">
        <div class="am-form-group">
            ...
            <input type="text" name="article_mark" value="<?= $article_mark ?>"  placeholder="文档唯一标记">
        </div>
