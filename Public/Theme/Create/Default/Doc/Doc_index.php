...
<form class="ajax-submit" action="<?= $label->url(GROUP . '-' . MODULE . '-listsort'); ?>" method="POST">
    ...
    <?php else: ?>
        <div class="am-alert am-alert-info am-margin-top am-margin-bottom am-text-center nothing-doc">
            <p class="am-margin-0">您还没创建过一份文档，马上点击左上角“新增”按钮创建吧。</p>
        </div>
    <?php endif; ?>
...
<?php include __DIR__ . '/Doc_index_driver.php' ?>
