...
<script>
    ...
    $('header').before('<div class="am-alert am-alert-postscript am-text-sm am-margin-0 " data-am-alert style="position: fixed;width: 100%;bottom: 0px"><button type="button" class="close-f1 am-close">&times;</button><i class="am-icon-leanpub"></i> 按F1可以打开PESCMS Doc帮助文档</div>')
