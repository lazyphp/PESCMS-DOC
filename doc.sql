...
--
-- Host: localhost
-- Generation Time: 2015-09-15 10:57:12
-- 服务器版本： 5.5.16
-- PHP Version: 5.4.39
...
(1, '序言', 1, 1, 1441274302, 1441274302, '0', 1);
...
CREATE TABLE IF NOT EXISTS `d_doc_content` (
  ...
  KEY `timelog_id` (`doc_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='文档内容' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `d_doc_join` (
  `doc_join_id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_id` int(11) NOT NULL COMMENT '日志ID',
  `user_id` int(11) NOT NULL COMMENT '参与者ID',
  `doc_join_time` int(11) NOT NULL COMMENT '加入时间',
  PRIMARY KEY (`doc_join_id`),
  UNIQUE KEY `timelog_id` (`doc_id`,`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='文档参与者' AUTO_INCREMENT=2 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='登录cookie' AUTO_INCREMENT=4 ;
...
(3, '57af4e75e02f45c576c81e5ba46826a1', 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.157 Safari/537.36');
...
CREATE TABLE IF NOT EXISTS `d_tree` (
  ...
  PRIMARY KEY (`tree_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='文档树' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `d_tree`
--

INSERT INTO `d_tree` (`tree_id`, `tree_listsort`, `tree_status`, `tree_lang`, `tree_createtime`, `tree_title`) VALUES
(1, 0, 0, 0, 0, '快速入门');
