...
--
-- Host: localhost
-- Generation Time: 2015-09-17 00:18:46
-- 服务器版本： 5.6.20
-- PHP Version: 5.6.0
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='文档基础表';
...
(1, '序言', 1, 2, 1441274302, 1441274302, 0, 3),
(2, '123', 1, 2, 1442410401, 1442418605, 0, 2),
(3, '新文档', 1, 4, 1442418829, 1442418829, 0, 0);
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='文档内容';
...
(2, 2, 1, '&lt;p&gt;123&lt;br/&gt;&lt;/p&gt;', 1442410401, 0),
(3, 2, 1, '&lt;p&gt;asdsad&lt;/p&gt;', 1442412429, 0),
(4, 2, 1, '&lt;p&gt;测试用的&lt;/p&gt;', 1442418605, 1442418774),
(5, 3, 1, '&lt;p&gt;213123&lt;/p&gt;', 1442418829, 1442419136);
...
`doc_content_history_id` int(11) NOT NULL,
  ...
  `doc_content_user_id` int(11) NOT NULL COMMENT '上一个版本创建者',
  `doc_content` text NOT NULL COMMENT '内容',
  `doc_content_updatetime` int(11) NOT NULL COMMENT '内容更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='文档内容';

--
-- 转存表中的数据 `d_doc_content_history`
--

INSERT INTO `d_doc_content_history` (`doc_content_history_id`, `doc_content_id`, `doc_content_user_id`, `doc_content`, `doc_content_updatetime`) VALUES
(1, 4, 1, '&lt;p&gt;12123213123&lt;/p&gt;', 1442418774),
(2, 5, 1, '&lt;p&gt;213123&lt;/p&gt;', 1442419133),
(3, 5, 1, '&lt;p&gt;213123&lt;/p&gt;', 1442419136);
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='登录cookie';
...
(13, '5715f96529d2a87eadc902b37dbb5a21', 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.85 Safari/537.36');
...
`tree_id` int(11) NOT NULL,
  `tree_parent` int(11) NOT NULL COMMENT '父类 0：文档层 ',
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='文档树';

--
-- 转存表中的数据 `d_tree`
--

INSERT INTO `d_tree` (`tree_id`, `tree_parent`, `tree_listsort`, `tree_status`, `tree_createtime`, `tree_title`) VALUES
(1, 0, 1, 0, 0, 'PESCMS开发文档'),
(2, 1, 1, 0, 0, '序言'),
(3, 0, 2, 0, 0, 'PESCMS TEAM'),
(4, 3, 0, 0, 0, '使用说明'),
(5, 1, 2, 0, 0, '配置与入门');
...
ALTER TABLE `d_doc_content_history`
 ADD PRIMARY KEY (`doc_content_history_id`), ADD KEY `timelog_id` (`doc_content_id`);
...
--
ALTER TABLE `d_doc_content`
MODIFY `doc_content_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `d_doc_content_history`
--
ALTER TABLE `d_doc_content_history`
MODIFY `doc_content_history_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
